...
#define MANUFACTURER Gabriel Ebner
#define PRODUCT alpengurke
#define DESCRIPTION Alpine keyboard
...
#define MATRIX_ROW_PINS { PIN20, PIN8, PIN6, PIN11, PIN10, PIN9 }
#define MATRIX_COL_PINS { PIN5, PIN7, PIN13, PIN14, PIN15 }
