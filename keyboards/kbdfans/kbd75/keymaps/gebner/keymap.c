...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT_ansi_1u(
    ...
    KC_LCTL,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCL_M, KC_QUOT,                      KC_ENT,   KC_PGDN,
    KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,            KC_RSFT,            KC_UP,    KC_END,
    MO(1),    KC_LGUI,  KC_LALT,                                MT(MOD_LSFT, KC_SPC),                   KC_RALT,  MO(2),    KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT
  ),
  ...
  [1] = LAYOUT_ansi_1u(
    ...
    _______,  _______,  KC_MS_L,  KC_MS_U,  KC_MS_D,  KC_MS_R,  KC_LEFT,  KC_DOWN,  KC_UP,    KC_RIGHT, _______,  _______,                      _______,  _______,
  ...
  [2] = LAYOUT_ansi_1u(
    ...
    _______,  KC_BTN1,  KC_BTN2,  KC_BTN3,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,            _______,  _______,
  ...
  [3] = LAYOUT_ansi_1u(
    ...
    _______,  _______,  _______,  BL_DEC,   BL_TOGG,  BL_INC,   BL_STEP,  _______,  _______,  _______,  _______,            _______,            _______,  _______,
